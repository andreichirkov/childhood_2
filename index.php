<?php get_header(); ?>
        ...
        <div class="toys" id="toys">
            <div class="container">
                <h2 class="subtitle"><?php the_field('toys_type_1'); ?></h2>
        ...
        <div class="aboutus" id="aboutus">
            <div class="container">
                <h2 class="title"><?php the_field('story'); ?></h2>
                <div class="row">
                    <div class="col-lg-6">
                        <div class="subtitle">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="contacts__feed">
                            <?php echo do_shortcode( '[contact-form-7 id="174" title="Форма отзывов"]'); ?>
                        </div>
                    </div>
                </div>
                <div class="row mt70">
                    <div class="col-lg-8 offset-lg-2">
                        ...
                        <div class="feedslider glide">
                            <div class="glide__track" data-glide-el="track">
                                ...
                                <ul class="glide__slides">
                                <!-- начало динамических отзывов -->
                                    <?php 
                                    // вывод отзывов как постов(записи)
